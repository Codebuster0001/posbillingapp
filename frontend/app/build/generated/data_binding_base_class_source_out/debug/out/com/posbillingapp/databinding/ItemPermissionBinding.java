...
public final class ItemPermissionBinding implements ViewBinding {
  ...
  private ItemPermissionBinding(@NonNull LinearLayout rootView, @NonNull CheckBox cbPermission,
      @NonNull TextView tvDescription) {
    this.rootView = rootView;
    this.cbPermission = cbPermission;
  ...
  public static ItemPermissionBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.cbPermission;
      CheckBox cbPermission = ViewBindings.findChildViewById(rootView, id);
      if (cbPermission == null) {
        break missingId;
      }
      ...
      return new ItemPermissionBinding((LinearLayout) rootView, cbPermission, tvDescription);
    }
